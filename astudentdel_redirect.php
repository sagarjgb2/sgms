...
<head>
    ...
    <div class="mnu" style="text-align:right">
        <a href="admin.php" style="text-decoration:none; color: rgb(15, 4, 77); font-family: 'Open Sans', sans-serif; font-weight:bold; padding: 12px 12px 12px 12px;">Dashboard</a>
        <a href="login.php" style="text-decoration:none; color: rgb(15, 4, 77); font-family: 'Open Sans', sans-serif; font-weight:bold; padding: 12px 12px 12px 12px;">Logout</a>
    </div>
</head>
<style>
    body{
    ...
    <section class="mn">
        ...
        <div class="oform">
            <form action="" method="post">
                ...
                <input type="USN" placeholder="Enter student usn" autofocus size="27"></br>
                </div>
