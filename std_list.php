...
<head>
    ...
    <div class="mnu" style="text-align:right">
        <a href="complaint_list.php" style="text-decoration:none; color: rgb(15, 4, 77); font-family: 'Open Sans', sans-serif; font-weight:Normal; padding: 12px 12px 12px 12px;">Dashboard</a>
